    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_handle', models.CharField(blank=True, max_length=50, unique=True)),
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('MANAGER', 'Manager'), ('ACCOUNTANT', 'Accountant')], default='ACCOUNTANT', max_length=20)),
                ('picture', models.ImageField(blank=True, null=True, upload_to=accounts.models.avatar_path)),
